...
- APIs **MUST** log and [monitor](./monitoring.md) resilience events resilience events (e.g., retries, circuit breaker state changes) to enable proactive troubleshooting and optimisation.
